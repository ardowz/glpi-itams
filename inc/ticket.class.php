...
//         echo "<option value='".strtolower($LANG['itrequest'][4])."'>".$LANG['itrequest'][4]."</option>";
         echo "<option value='".strtolower($LANG['itrequest'][5])."'>".$LANG['itrequest'][5]."</option>";
      echo "</select>";
...
//                        && empty($this->fields['solution']);
       ...
       * sideb thesis adjustment
       * removing solution
       * removing parts of the solution
       */
      if ($show_template) {
...
//      echo "</span>";
   ...
   /*
    * sideb thesis adjustment
    * making own function to skip step of user
    */
   
   static function AssignUserDropdown($actortype,$entities_id,$withemail){
       global $LANG, $CFG_GLPI;
       
       $assigntpye = "user";
       if (isset($assigntpye) && isset($actortype)) {
       $rand = mt_rand();
       $assigntpye = "user";
       ...
       switch ($assigntpye) {
          ...
          case "group" :
             Dropdown::show('Group', array('name'   => '_ticket_'.$actortype.'[groups_id]',
...
//
   ...
   function showForm($ID, $options=array()) {
      ...
      if ($canupdate) {
//          Sideb thesis adjustment *Start of form adjustment
