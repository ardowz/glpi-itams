...
*/
   ...
   **/
    ...
    * Dropdown for all software available
    */
   
   static function dropdownSoftwareList($myname, $entity_restrict, $massiveaction=0) {
      global $CFG_GLPI;
      ...
      ajaxDropdown($use_ajax, "/ajax/dropdownSoftwareToChoose.php", $params, $default, $rand);
