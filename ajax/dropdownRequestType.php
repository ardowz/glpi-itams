...
// Make a select box
   ...
   switch ($_POST["type"]) {
      case "software" :
         $right = 'all';
          $formname = "my_software";
          Software::dropdownSoftwareListRequest($formname, $entity_restrict);
...
//         echo "component";
         ...
         Ticket::dropdownAllDevices("itemtype", $itemtype, $items_id, 0,
           ...
           //ajax component dropdown
         
         $params = array('type' => '__VALUE__');
         
         ajaxUpdateItemOnSelectEvent("my_items", "notif_user",
                            $CFG_GLPI["root_doc"]."/ajax/dropdownComponents.php",
                            $params);
