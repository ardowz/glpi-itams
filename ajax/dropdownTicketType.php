...
// Make a select box
   ...
   switch ($_POST["type"]) {
       ...
       case "2" :
           $name = "request";
           $id = Ticket::dropdownItRequest($name);
           
           
           $params = array('type'            => '__VALUE__');
           ajaxUpdateItemOnSelectEvent($id,
                                  "ticket_request_type_".$rand,
                                  $CFG_GLPI["root_doc"]."/ajax/dropdownRequestType.php", $params);
           
           echo "<span id='ticket_request_type_$rand'>&nbsp;</span>";
